...
export async function POST(req: NextRequest) {
  ...
  // 5. Buscar itens do pedido com pdf_key do produto
  ...
  // 6. Gerar signed URLs temporárias (1h) para cada PDF no R2
  ...
  // 7. Buscar e-mail do comprador via auth.users (service role)
