...
export default function ShareButtons({ slug, titulo }: Props) {
  const [copied, setCopied] = useState(false)

  const url = `${BASE_URL}/atividades/${slug}`
  const text = `Olha essa atividade: ${titulo}`
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className="flex items-center justify-center w-8 h-8 rounded-full bg-green-50 hover:bg-green-100 transition-colors"
